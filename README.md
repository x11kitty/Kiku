...
Created with <span style="color: #9f7aea;"></span></p></footer>

<div align="center">
  <img src="Assets/mp.gif" width="70%" style="filter: drop-shadow(0px 0px 8px #9f7aea);" alt="Kiku Audio Visualizer"/>
